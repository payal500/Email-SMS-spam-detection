...
**Features**
**Real-time Spam Detection**__: Classifies messages instantly using trained machine learning models.
...
**Logistic Regression**: Provides robust classification performance.
**Text Preprocessing:**
...
TF-IDF Vectorization: Converts textual data into numerical format for model processing.
